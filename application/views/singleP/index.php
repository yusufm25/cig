			...
			<div class="row s_product_inner">
						...
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img class="d-block w-100" src="<?php echo base_url(),$produk['gambar']?>" alt="First slide">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<div class="card_area">
						<button type="submit" name="tambah" class="main_btn">
						Add to Cart
						</button>
						</div>
						</form>
						...
						<div class="col-lg-6">
							<div class="comment_list">
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											<img src="<?= base_url() ?>assets/img/product/single-product/review-1.png" alt="">
										</div>
								...
								<div class="review_item reply">
									<div class="media">
										<div class="d-flex">
											<img src="<?= base_url() ?>assets/img/product/single-product/review-2.png" alt="">
										</div>
										<div class="media-body">
											<h4>Blake Ruiz</h4>
											<h5>12th Feb, 2017 at 05:56 pm</h5>
								...
								<div class="review_item">
									<div class="media">
										<div class="d-flex">
											<img src="<?= base_url() ?>assets/img/product/single-product/review-3.png" alt="">
										</div>
										<div class="media-body">
											<h4>Blake Ruiz</h4>
											<h5>12th Feb, 2017 at 05:56 pm</h5>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="single-footer-widget instafeed">
						...
						<ul class="list instafeed d-flex flex-wrap">
							<li>
								<img src="<?= base_url() ?>assets/img/instagram/Image-01.jpg" alt="">
							</li>
							<li>
								<img src="<?= base_url() ?>assets/img/instagram/Image-02.jpg" alt="">
							</li>
							<li>
								<img src="<?= base_url() ?>assets/img/instagram/Image-03.jpg" alt="">
							</li>
							<li>
								<img src="<?= base_url() ?>assets/img/instagram/Image-04.jpg" alt="">
							</li>
							<li>
								<img src="<?= base_url() ?>assets/img/instagram/Image-05.jpg" alt="">
							</li>
							<li>
								<img src="<?= base_url() ?>assets/img/instagram/Image-06.jpg" alt="">
							</li>
							<li>
								<img src="<?= base_url() ?>assets/img/instagram/Image-07.jpg" alt="">
							</li>
							<li>
								<img src="<?= base_url() ?>assets/img/instagram/Image-08.jpg" alt="">
							</li>
						</ul>
					</div>
				</div>
