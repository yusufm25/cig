						...
						<div class="row w-100">
							...
							<div class="col-lg-5">
								<ul class="nav navbar-nav navbar-right right_nav pull-right">
									...
									<li class="nav-item">
									<a href="<?=base_url()?>cart/index" class="icons">
	...
	<section class="clients_logo_area">
		<div class="container-fluid">
			<div class="clients_slider owl-carousel">
				<div class="item">
					<img src="<?php echo base_url()?>assets/img/clients-logo/c-logo-1.png" alt="">
				</div>
				<div class="item">
					<img src="<?php echo base_url()?>assets/img/clients-logo/c-logo-2.png" alt="">
				</div>
				<div class="item">
					<img src="<?php echo base_url()?>assets/img/clients-logo/c-logo-3.png" alt="">
				</div>
				<div class="item">
					<img src="<?php echo base_url()?>assets/img/clients-logo/c-logo-4.png" alt="">
				</div>
				<div class="item">
					<img src="<?php echo base_url()?>assets/img/clients-logo/c-logo-5.png" alt="">
				</div>
			</div>
		</div>
	</section>
				...
				<?php foreach ($produk as $prd) : ?>
					<div class="col col1">
						<div class="f_p_item">
							<div class="f_p_img">
							<div>
								<img class="img-fluid" src="<?php echo base_url(),$prd['gambar']?>" alt="">
							</div>
								<div class="p_icon">
									<a href="<?= base_url(); ?>singleP/detail/<?= $prd['id']?>">
